...
ALTER TABLE oficina
ADD CONSTRAINT PK_oficina PRIMARY KEY (codigo_oficina)
...
ADD CONSTRAINT FK_empleado_jefe FOREIGN KEY (codigo_jefe) REFERENCES empleado (codigo_empleado)
...
ADD CONSTRAINT PK_gama PRIMARY KEY (gama)
...
ADD CONSTRAINT FK_cliente_empleado FOREIGN KEY (codigo_empleado_rep_ventas) REFERENCES empleado (codigo_empleado)
...
ALTER TABLE pedido
ADD CONSTRAINT PK_pedido PRIMARY KEY (codigo_pedido),
...
ADD CONSTRAINT FK_producto_gama_producto FOREIGN KEY (gama) REFERENCES gama_producto (gama)
...
ADD CONSTRAINT PK_detalle_pedido PRIMARY KEY (codigo_pedido, codigo_producto),
...
ALTER TABLE pago
ADD CONSTRAINT PK_pago PRIMARY KEY (codigo_cliente, id_transaccion),
